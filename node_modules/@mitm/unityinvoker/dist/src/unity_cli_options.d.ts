export declare type Flag = boolean;
export declare type BuildTarget = 'win32' | 'win64' | 'osx' | 'linux' | 'linux64' | 'ios' | 'android' | 'web' | 'webstreamed' | 'webgl' | 'xboxone' | 'ps4' | 'psp2' | 'wsaplayer' | 'tizen' | 'samsungtv' | string;
